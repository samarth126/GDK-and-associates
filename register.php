      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="services.php"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
            <li><a href="pages/audit.php">Audit Experience in the Banking Sector</a></li>
              <li><a href="pages/audit1.php">Audit Experience of Companies incorporated under the Indian Companies Act</a></li>
              <li><a href="pages/audit2.php">Audit Experience of Non-Corporate Entities</a></li>
              <li><a href="pages/directtax.php">Experience of Direct Taxes</a></li>
              <li><a href="pages/indirecttax.php">Experience of Indirect Taxes</a></li>
              <li><a href="pages/eclm.php">Experience of Corporate Law Matters</a></li>
